                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-4 flex-1">
                        <div className={`p-2 rounded-lg ${
                          ...
                          notification.type === 'success' ? 'bg-green-100' : 'bg-emerald-100'
                        }`}>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-4 text-sm">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                              notification.category === 'system' ? 'bg-blue-100 text-blue-800' :
                              notification.category === 'voting' ? 'bg-purple-100 text-purple-800' :
                              notification.category === 'registration' ? 'bg-green-100 text-green-800' :
                              notification.category === 'analytics' ? 'bg-orange-100 text-orange-800' :

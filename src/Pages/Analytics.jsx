    ...
    <div className="min-h-screen ml-10 bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm border-b border-green-100 dark:border-gray-700">
        <div className="px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Civix Analytics</h1>
              <p className="text-gray-600 dark:text-gray-300 mt-1">Monitor platform engagement and community growth</p>
            </div>
            <div className="flex items-center space-x-4">
              <select 
                value={timeRange} 
                onChange={(e) => setTimeRange(e.target.value)}
                className="border border-green-200 dark:border-gray-600 rounded-lg px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-green-500 focus:border-green-500"
              >
      ...
      <div className="px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-green-100 dark:border-gray-700 p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-6">Discussion Categories</h3>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={categoryData}
            ...
            <div className="mt-4 space-y-2">
              {categoryData.map((category, index) => (
                <div key={index} className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{category.value}%</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-green-100 dark:border-gray-700 p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-6">Weekly Engagement</h3>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-green-100 dark:border-gray-700 p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Geographic Reach</p>
                <p className="text-xl font-bold text-gray-900 dark:text-gray-100">47 Cities</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-green-100 dark:border-gray-700 p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Scheduled Events</p>
                <p className="text-xl font-bold text-gray-900 dark:text-gray-100">23</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-green-100 dark:border-gray-700 p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Moderation Queue</p>

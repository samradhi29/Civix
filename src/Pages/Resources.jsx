          ...
          <section className="group bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 dark:border-gray-700/50 hover:shadow-xl hover:shadow-green-500/10 dark:hover:shadow-emerald-500/10 transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="space-y-4">
              {faqData.map((item, index) => (
                <div key={index} className="border border-gray-200 dark:border-gray-600 rounded-xl overflow-hidden bg-gradient-to-r from-green-50/50 to-emerald-50/50 dark:from-gray-700/30 dark:to-emerald-900/10">
                  <button
                    className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-green-50 dark:hover:bg-gray-700/50 transition-colors duration-200"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-center w-8 h-8 bg-green-100 dark:bg-green-800/30 rounded-full flex-shrink-0">
                      {openIndex === index ? (
                  ...
                  {openIndex === index && (
                    <div
                      className="px-6 py-4 bg-white/50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-600 animate-in slide-in-from-top-2 duration-200"
                      id={`faq-answer-${index}`}
                      role="region"
